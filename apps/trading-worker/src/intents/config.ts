...
//   < SHUTDOWN_BUDGET_MS                                — a SIGTERM during a submit waits it out
//   < compose stop_grace_period (40 s)                  — the process is never SIGKILLed mid-write
...
export const SHUTDOWN_BUDGET_MS = 35_000;
...
export const TIMING_CHAIN_HOLDS =
  MAX_SUBMIT_ACK_TIMEOUT_MS < SHUTDOWN_BUDGET_MS &&
